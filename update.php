...
if (!empty($_POST)) {
    ...
    if ($validacao) {
        ...
        $q = $pdo->prepare($sql);
        $q->execute(array($nome, $endereco, $telefone, $email, $idade, $id));
        Banco::desconectar();
        header("Location: index.php");
    }
} else {
    ...
    <div class="container">
        ...
        <div class="span10 offset1">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="update.php?codigo=<?php echo $id ?>" method="post">
                        ...
                        <div class="control-group <?php echo !empty($idadeErro) ? 'error' : ''; ?>">
                            ...
                            <div class="controls">
                                <input name="idade" class="form-control" size="40" type="text" placeholder="Idade"
